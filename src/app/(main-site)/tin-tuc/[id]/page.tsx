...
const NewsDetail = () => {
  ...
  return (
    <div className="relative w-full px-[4%] md:px-[10%] py-[8%] flex flex-col items-center text-[#492EAB]">
      ...
      <img src="/images/tin-tuc/custom-line.webp" alt="" className="mt-[3%] md:mt-[1%] w-[95%] md:w-[80%] object-contain" />

      {data && <div className="mt-[2%] w-full h-[calc((1107/613)*45vw)] md:h-[calc((1107/613)*35vw)] overflow-x-hidden overflow-y-scroll hide-scroll">
